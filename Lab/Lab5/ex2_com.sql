...
SELECT idA, a2 FROM Ta WHERE a2 BETWEEN 1000 AND 2000; --NonClustered Seek

SELECT a2 FROM Ta WHERE a2 < 5000 ORDER BY idA; --Clustered Scan

SELECT idA, a2 FROM Ta ORDER BY a2; --NonClustered Scan


--2/b)
SELECT idA, a2, a3 FROM Ta WHERE a2 = 1000; --NonClustered Seek, Key Lookup


--2/c)
EXEC sys.sp_helpindex @objname = N'dbo.Tb';

SELECT idB, b2, b3 FROM Tb WHERE b2 = 201; --Clustered Scan, 0.01
